...
public class WrappableGridLayoutManager extends GridLayoutManager {
    ...
    private int extraHeight = 100;

    public WrappableGridLayoutManager(Context context, int spanCount) {
        super(context, spanCount);
    }

    public WrappableGridLayoutManager(Context context, int spanCount, int extraHeight){
        super(context, spanCount);
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        setMeasuredDimension(width, height + extraHeight);
    }
