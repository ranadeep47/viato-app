 ...
 */
public class CheckoutListViewHoler extends RecyclerView.ViewHolder implements View.OnClickListener {
    private static FragmentCheckoutListItemBinding mBindinig;
